...
<BODY onload=resetme()><?php $menu=""; include("includes/menu2.php"); ?>
  ...
  <TR vAlign=top>
    <TD class=mainBG><BR><BR>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD><FONT size=4><STRONG><FONT face=Arial>Secure TV 
            Service</FONT></STRONG></FONT></TD>
          <TD align=right><FONT size=4><FONT face=Arial>$25 + Service 
            Call</FONT></FONT></TD></TR></TBODY></TABLE>
      <DIV class=rndbg>
      <DIV align=center><IMG src="images/product-image-secure-TV.png" 
      width=746></DIV>
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          <TD vAlign=top width="65%">
            ...
            <DIV class=fadecontent><STRONG>Protect more than your 
            investment:<BR><BR></STRONG>Did you know an unsecured tabletop TV is 
            the most dangerous? If you have children, pets or just want to 
            prevent your expensive investment from toppling over unexpectedly 
            then consider making your tabletop TV safer with our Secure TV 
            Service.&nbsp;&nbsp;<BR><BR><STRONG>Hidden Danger:</STRONG>&nbsp;Pet 
            and kids tend to pull-on, grab or jump up onto the TV area allowing 
            it to rock, wobble and possibly fall forward causing severe injury 
            or even worse. Contact Honest to schedule an appointment today. 
            <BR><BR><STRONG>How it works:&nbsp;</STRONG>A Honest Install 
            technician will arrive with all the necessary<BR>hardware to tether 
            your TV to the wall structure or secure the base 
            depending&nbsp;<BR>upon your setup to ensure that it will not be 
            able to stray for an upright position, giving you peace of 
            mind.</DIV></DIV>
            <DIV class=fadebottom></DIV></TD>
          <TD vAlign=top width="35%">
            <DIV class=custreview>
            <H4>What Customers Say</H4>"I've&nbsp;used Honest Install more than 
            once,&nbsp;first time was to take&nbsp;a 46-inch&nbsp;TV off a wall 
            mount.&nbsp;They did a great job taking out the mount and repairing 
            the wall so it looked like the&nbsp;TV had never been 
            there.&nbsp;<BR><BR>Then they took that TV to my daughter's 
            apartment and installed a&nbsp;secure safety cable to the wall in 
            order to protect my granddaughter. Honest&nbsp;is great at getting 
            the work done quickly, and they provide good workmanship, including 
            manners!"<BR><BR>By Carol N.&nbsp;<BR>
            Carrollton, 
        TX</DIV></TD></TR></TBODY></TABLE></DIV></DIV><IMG 
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD vAlign=top><BR><BR><TEXTAREA class=txtheight onClick="document.serviceform.Comments.value='';" rows=15 cols=36 name=Comments>Comments</TEXTAREA><small>*Honest Install will never sell or share your information.</small><BR><BR><INPUT 
            ...
            value="Secure TV Inquiry" type=hidden name=subject> <INPUT 
