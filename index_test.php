<?php $menu='home'; include("header_test.php"); ?>
	<div class="mainBG">
		<div align="center">
			<div class="contents">
				<div id="demo">
...
<br>
		...
		<div class="social-home">
			...
			<div class="column-four" style="text-align:left">
				...
				<a href="http://www.yelp.com/biz/honest-install-dallas" target="_blank"><img src="images/genericYelpBizButton.png" alt="yelp" /></a>
				
			</div>
			<div class="clear"></div>
		</div>
	</div>
<?php require("footer_test.php"); ?>