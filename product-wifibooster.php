  ...
  <TR vAlign=top>
    <TD class=mainBG><BR><BR>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD><FONT size=4><STRONG><FONT face=Arial>Wi-Fi 
            Amplifier/Booster</FONT></STRONG></FONT></TD>
          <TD align=right><FONT size=4><FONT face=Arial>from $99 + 
            Installation</FONT></FONT></TD></TR></TBODY></TABLE>
      <DIV class=rndbg>
      <DIV align=center><IMG class=marginfix 
      src="images/product-image-wi-fi-booster.png" width=746></DIV>
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          <TD vAlign=top width="65%">
            ...
            <DIV class=fadecontent>Love the Freedom of Wi-Fi but hate the weak 
            signal strength in some parts of your home or business? We can help 
            by boosting your Wireless Router:<BR><BR>Honest Install offers Wi-Fi 
            ...
            (such as&nbsp;actiontec SMC &amp; 2-Wire routers). Not always 
            compatible with all facilities, poor signal strength could be 
            experienced in areas/rooms with brick, steel, aluminum, dense wood 
            or concrete walls. </SMALL><BR></DIV></DIV>
            <DIV class=fadebottom>&nbsp;</DIV></DIV></TD>
          <TD vAlign=top width="35%" align=right>
            <H4 class=custreview>What Customers Say</H4>
            <P class=custreview align=left>"Great Customer Service! 
            <BR><BR>Honest Install has done several jobs for me. They most 
            recently increased the power of my wireless router. I had wireless, 
            but I wasn't able to access the wi-fi across the house. 
            <BR><BR>Their follow-up service is excellent. I have been extremely 
            pleased with them each time and will definitely use them 
            again."<BR><BR>By Marsha M. <BR>Dallas, 
            TX<BR><BR><BR><BR><BR><BR><BR><BR><BR></P></TD></TR></TR></TBODY></TABLE></DIV></DIV><IMG 
      src="../../../../../images/bottomround.jpg"> 
      <DIV class=formbox>
      <H4>Schedule It or Ask a Question</H4>
      <FORM method=post name=serviceform action=/scripts/serviceform.php>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD width=166>
