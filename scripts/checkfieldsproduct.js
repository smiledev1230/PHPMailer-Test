...
if(NoneWithCheck(document.serviceform.Subject))
	{errormessage += "\n\nPlease select the type of your inquiry."; }
if(WithoutContent(document.serviceform.phone.value))
	{ errormessage += "\n\nPlease enter your phone in the \"Phone\" text field."; }
if(WithoutContent(document.serviceform.realname.value))
	{ errormessage += "\n\nPlease enter your full name in the \"Full Name\" text field."; }
	
if(!isEmail(document.serviceform.email.value))
