	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			function addControls() {
				$wrap.append('<p class="jshowoff-controls '+uniqueClass+'-controls"> <a class="jshowoff-prev '+uniqueClass+'-prev" href="#null"> <img src="/images/Pag-a-nation-arrow-left.gif" /> </a> <a class="jshowoff-next '+uniqueClass+'-next" href="#null"><img src="/images/Pag-a-nation-arrow-right.gif" /></a></p>');
			...
			function addSlideLinks() {
				//$wrap.append('<p class="jshowoff-controls '+uniqueClass+'-controls"> <a class="jshowoff-prev '+uniqueClass+'-prev" href="#null"> <img src="/cssimages/sl_prev.png" /> </a> <a class="jshowoff-next '+uniqueClass+'-next" href="#null"><img src="/cssimages/sl_next.png" /></a></p>');
