...
function addEvent( obj, type, fn ) {
  if ( obj.attachEvent ) {
	...
	__RULES = [];
	__ENTRY = [];
	__PRICES = {"ShowRunningTotal":true,"BasePrice":"0.00","Currency":"&#36;","Decimals":2,"BasePriceName":"Base Price","TotalText":"Total","MerchantFields":[{"Title":"Asdfmount","Typeof":"money","ColumnId":"8","Price":"1","IsQuantity":"0","ChoicesText":"0"}],"BasePriceText":"Base Price"};