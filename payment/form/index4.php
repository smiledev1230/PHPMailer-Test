...
<body id="public" style="display:none">
...
<?php echo "$$amount_dollar.$amount_cents<BR><BR><HR>"; ?>

<h3 align="center" style="padding-bottom:0;font-weight:normal;display:none" class="selecthead">Select a payment method:</h3>
...
<span>
<input id="Field1" name="Field1" type="text" class="field text fn" value="<?php echo $fname; ?>" size="8" tabindex="1"       required />
<label for="Field1">First</label>
</span>
<span>
<input id="Field2" name="Field2" type="text" class="field text ln" value="<?php echo $lname; ?>" size="14" tabindex="2" required />
...
<span>
<input id="Field8" name="Field8" type="text" class="field text currency nospin" value="<?php echo $amount_dollar; ?>" size="10" tabindex="3" style="display:none"/>
<label for="Field8" style="display:none">Dollars</label>
</span>
<span class="symbol radix"></span>
<span class="cents">
<input id="Field8-1" name="Field8-1" type="text" class="field text nospin" value="<?php echo $amount_cents; ?>" size="2" maxlength="2" tabindex="4"    style="display:none"   />
...
<li id="fo1li111" 		class="notranslate      " style="display:none" ?>>
	...
	<div>
		<input id="Field111" 			name="Field111" 			type="email" 			spellcheck="false" 			class="field text medium" 			value="<?php echo $email; ?>" 			maxlength="255" 			tabindex="5"       						onkeyup="handleInput(this);" 			onchange="handleInput(this);" 									/>
	</div>
	</li>
...
<div>
<input id="Field4" name="Field4" type="text" class="field text medium" value="<?php echo $company; ?>" maxlength="255" tabindex="5" onkeyup=""       />
</div>
</li>
...
<div>
<input id="Field5" name="Field5" type="text" class="field text medium" value="<?php echo $reference; ?>" maxlength="255" tabindex="6" onkeyup=""       />
</div>
</li>
<li id="foli6"
...
<input type="image" src="https://honestinstall.com/images/CC-Square2.png" border="0" name="saveForm"  class="ccimg" style="display:none">
 </div>
</li>
...
<input type="image" src="https://honestinstall.com/images/e-Check-Square.png" border="0" name="saveForm"  class="ccimg" style="display:none">
 </div>
</li>
...
<div align="center">
<p style="font-size:13px">Stuck or Need Help?  972-470-3528 | <a href="mailto:payments@honestinstall.com">payments@honestinstall.com</a></p><br>
