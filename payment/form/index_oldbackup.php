...
<style>
  ...
  .paypal{position:relative;z-index:9999;float:right;margin-top:-230px;padding-right:20px;display:none}
...
<input type="image" src="https://honestinstall.com/images/CC-Square.png" border="0" name="saveForm"  class="ccimg">
 </div>
</li>
...
<div  class="paypal">
<a href="<? echo" https://honestinstall.com/payment/paypal/index.php?Field1=$fname&Field2=$lname&Field8=$amount_dollar&Field8-1=$amount_cents&Field4=$company&Field5=$reference&Field6=$notes&email=$email"; ?>">
<img src="https://honestinstall.com/images/paypal.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"  class="paypalimg"></a>
</div>
