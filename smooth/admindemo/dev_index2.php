...
<?php endfor; ?>
        ...
        <script type="text/javascript">
            jQuery(function($) {
                ...
                /*
                 $("#carousel-image-and-text").click(function() {
                 if (play == true) {
                 sliderInstance.stopAutoplay();
                 play = false;
                 } else {
                 $('#carousel-image-and-text').mousedown(function() {
                 clicking = true;
                 console.log("mousedown");
                 });
                 
                 $('#carousel-image-and-text').mouseup(function() {
                 clicking = false;
                 //console.log('mouseup, click released, no more event');
                 });
                 
                 
                 $('#carousel-image-and-text').mousemove(function() {
                 if (clicking === false) {
                ...
                $("#carousel-image-and-text").mouseenter(function() {
                    console.log("hover");
                    sliderInstance.stopAutoplay();
                });

                $("#carousel-image-and-text").mouseleave(function() {
                    console.log("unhover");
                    sliderInstance.resumeAutoplay();
                });
        ...
        <div id="carousel-image-and-text" class="touchcarousel grey-blue">       
            <ul class="touchcarousel-container">
                <?php for ($columnPosition = 1; $columnPosition <= $totalColumn; $columnPosition++) : ?>
                    <li class="touchcarousel-item" style="margin-left: 50px;">
