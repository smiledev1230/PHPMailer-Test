...
<?php for ($column = 1; $column <= $totalColumn; $column++): ?>
                    $("#tabs2-column<?php echo  $column; ?>").tabs();

                    CKEDITOR.replace('row1textareaimage-column<?php echo  $column; ?>', {
                        allowedContent: true,
                        toolbar: [
                    ...
                    CKEDITOR.replace('row2textareaimage-column<?php echo  $column; ?>', {
                        allowedContent: true,
                        toolbar: [
                            ['Undo', 'Redo', 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript',
                                '-', 'RemoveFormat', 'Font', 'FontSize', 'Link', 'Unlink', '-', 'Source',
                    ...
                    CKEDITOR.replace('row3textareaimage-column<?php echo  $column; ?>', {
                        allowedContent: true,
                        toolbar: [
                            ['Undo', 'Redo', 'Bold', 'Italic', 'Underline', 'Strike', 'Subscript', 'Superscript',
                                '-', 'RemoveFormat', 'Font', 'FontSize', 'Link', 'Unlink', '-', 'Source',
...
<?php endfor; ?>
    ...
    <body>
        ...
        <div style="width: 100%;  overflow-x: scroll; background: white;"> 
            <div id="logoParade" style="height: 750px; width:<?php echo  $totalColumn * 400; ?>px; cursor:pointer;">
                    ...
                    <?php for ($columnPosition = 1; $columnPosition <= $totalColumn; $columnPosition++) : ?>
                        <p>     
                            <?php for ($rowPosition = 1; $rowPosition <= 3; $rowPosition++) : ?>
                                <label style="background: yellow; color: black;">Column:<?php echo  $columnPosition; ?> &nbsp;&nbsp;&nbsp;Row: <?php echo  $rowPosition; ?></label>
                                <label class="bubble">
                                    <span class="futuratxt">
                                        <?php echo  $data[$rowPosition][$columnPosition]['description']; ?>
                                    </span>
                                </label>          
                                <br/>
                            <?php endfor; ?>
    ...
    <div style="float: left;margin-top: 43px; margin-left: 20px; color: black;">
        <form method="POST" action="set_interval.php">
            Scroll interval speed: <input type="text" name="interval" value="<?php echo  readInterval(); ?>"/>
    ...
    <div id="tabs">
        <ul>
            <?php for ($column = 1; $column <= $totalColumn; $column++) : ?>
                <li><a href="#tabs-<?php echo  $column; ?>">Column <?php echo  $column; ?></a></li>
            <?php endfor; ?>
        </ul>

        <?php for ($column = 1; $column <= $totalColumn; $column++): ?>
            <div id="tabs-<?php echo  $column; ?>">
                <div id="tabs2-column<?php echo  $column; ?>">
                    <ul>
                        <li><a href="#tabs2-column<?php echo  $column; ?>-row1">Row 1</a></li>
                        <li><a href="#tabs2-column<?php echo  $column; ?>-row2">Row 2</a></li>
                        <li><a href="#tabs2-column<?php echo  $column; ?>-row3">Row 3</a></li>
                    </ul>

                    <div id="tabs2-column<?php echo  $column; ?>-row1">
                        <form enctype="multipart/form-data" action="post.php" method="post">
                            <input type="hidden" name="max_column" value="<?php echo  $totalColumn; ?>"/>
                            <div id="row1-column<?php echo  $column; ?>">
                                <input type="hidden" name="form-row1-column<?php echo  $column; ?>" value="1"/>
                                <input type="hidden" name="row" value="1"/>
                                <input type="hidden" name="column" value="<?php echo  $column; ?>"/>
                                <input type="hidden" name="<?php echo  'radio_row1-column' . $column; ?>" value="image_text"/>
                                <div id="row1textimage-column<?php echo  $column; ?>">
                                    <p>
                                        <textarea id="row1textareaimage-column<?php echo  $column; ?>" name="row1textimage-column<?php echo  $column; ?>"><?php echo  $data[1][$column]['description']; ?></textarea>
                                    </p>
                                </div>
                            </div>      
                            <br/>
                    ...
                    <div id="tabs2-column<?php echo  $column; ?>-row2">
                        <form enctype="multipart/form-data" action="post.php" method="post">
                            <input type="hidden" name="max_column" value="<?php echo  $totalColumn; ?>"/>
                            <div id="row2-column<?php echo  $column; ?>">
                                <input type="hidden" name="form-row2-column<?php echo  $column; ?>" value="1"/>
                                <input type="hidden" name="row" value="2"/>
                                <input type="hidden" name="<?php echo  'radio_row2-column' . $column; ?>" value="image_text"/>
                                <input type="hidden" name="column" value="<?php echo  $column; ?>"/>

                                <div id="row2textimage-column<?php echo  $column; ?>">
                                    <p>
                                        <textarea id="row2textareaimage-column<?php echo  $column; ?>" name="row2textimage-column<?php echo  $column; ?>"><?php echo  $data[2][$column]['description']; ?></textarea>
                                    </p>
                                </div>
                    ...
                    <div id="tabs2-column<?php echo  $column; ?>-row3">
                        <form enctype="multipart/form-data" action="post.php" method="post">
                            <input type="hidden" name="max_column" value="<?php echo  $totalColumn; ?>"/>
                            <div id="row3-column<?php echo  $column; ?>">
                                <input type="hidden" name="form-row3-column<?php echo  $column; ?>" value="1"/>
                                <input type="hidden" name="row" value="3"/>
                                <input type="hidden" name="column" value="<?php echo  $column; ?>"/>
                                <input type="hidden" name="<?php echo  'radio_row3-column' . $column; ?>" value="image_text"/>

                                <div id="row3textimage-column<?php echo  $column; ?>">
                                    <p>
                                        <textarea id="row3textareaimage-column<?php echo  $column; ?>" name="row3textimage-column<?php echo  $column; ?>"><?php echo  $data[3][$column]['description']; ?></textarea>
                                    </p>
                                </div>                                                                                                  
                            </div>
                            <br/>
