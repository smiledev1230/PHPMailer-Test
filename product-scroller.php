...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>Honest Install - WE INSTALL EPSON PROJECTORS</TITLE>
...
<BODY onload=resetme()><?php $menu=""; include("includes/menu2.php"); ?>
      ...
      <DIV align=center>
<iframe src="slideshow/SlideShowv3/Slideshow.html" width="848" height="490" frameborder="0"></iframe>
</DIV>
<TABLE border=0 cellSpacing=0 cellPadding=0 width=850 align=center>
  <TBODY>
  <TR vAlign=top>
    <TD class=mainBG><div style="text-align:center;color:#000">
<small>*Prices are subject to change without notice from manufacture and/or supplier. Please call to verify current pricing.</small></div><BR><BR>
      HONEST INSTALL is an authorized dealer for Epson Home Cinema or Epson Pro Cinmea projectors. As an authorized Epson projector reseller HONEST INSTALL is able to bring the Epson store to you.  Currently The following Epson projecotr models are available from Epson by HONEST INTALL: Epson 8350, Epson 9350 (Pro Cinema), Epson 3010, Epson 3010e, Epson 5010, Epson 5010e and the Epson 6010 (Pro Cinema).  HONEST INSTALL provides sales and installation within Dallas/Ft. Worth for all Epson Projectors. Contact HONEST INSTALL today to purchase or intall EPSON projectors: 972-470-3528.  <br>
<br>
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD vAlign=top><BR><BR><TEXTAREA class=txtheight onClick="document.serviceform.Comments.value='';" rows=15 cols=36 name=Comments>Comments</TEXTAREA><BR><BR><INPUT 
            ...
            value="Epson Projector Inquiry" type=hidden name=subject> <INPUT value=Submit 
