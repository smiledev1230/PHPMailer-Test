...
<link href="jquery-upload/css/uploadfile.min.css" rel="stylesheet">
<script src="jquery-upload/js/jquery.uploadfile.min.js"></script>
	...
	(function($) {
		...
		$(function() {
			...
			$("#fileuploader").uploadFile({
				url:"jquery-upload/php/upload.php",
				fileName:"myfile",
				showDelete: true,
				showPreview:true,
				previewHeight: "50px",
				previewWidth: "50px",
				dragDropStr: false,
				uploadStr: "CHOOSE IMAGES",
				returnType: "json",
				onLoad:function(obj) {
				   	$.ajax({
					    	cache: false,
						    url: "jquery-upload/php/load.php",
					    	dataType: "json",
				...
				deleteCallback: function (data, pd) {
				    for (var i = 0; i < data.length; i++) {
				        $.post("jquery-upload/php/delete.php", {op: "delete",name: data[i]},
...
<div class="form">
        ...
        <div class="formcenter">
            ...
            <form id="qservice" class="qservice" action="sendform1.php" method="post" enctype="multipart/form-data">
				<input type="hidden" name="webpage"  value="<? echo $webpage; ?>">
                <span class="form-radio-item">
                	<select id="schedule_select" name="im">
                		<option value="Schedule Me (I'm ready for an appointment)">Schedule Me (I'm ready for an appointment)</option>
                		<option value="Inquiry (I have a questions or want a quote)">Inquiry (I have a questions or want a quote)</option>
                	</select>
                </span>
                ...
                <div class="group" style="position:relative;">
                	<label class="form-label">Send us Images of your Project:</label>
                </div>
                <div class="group" style="margin-bottom:0px;">
                	<div id="fileuploader">Choose Images</div>
                </div>
                <div class="tellus">
                ...
                <div class="group-radio gres">
                    ...
                    <span class="form-radio-item paddtop">
                        ...
                        <span class="form-checkbox-item">
                            ...
                            <input class="cbox" type="checkbox" name="rgroup_cbox[]" value="Surround Sound Install"> Surround Sound Install<br>
