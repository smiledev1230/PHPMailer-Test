<?php $menu='home'; include("headertemp.php"); ?>
...
<div style="font-size:22px;font-family:'archivo_narrowregular';clear:both">
<strong>600+ & Counting...</strong> We Work for it - Read our Reviews:
		...
		<div class="social-home">
			...
			<div class="column-four">
				...
				<div style="display:block;text-align:center;margin-left:-15px"><div style="padding-left:15px"><a href="https://www.facebook.com/honestinstall" target="_blank"><img src="/images/footer/FB-Icon.png" alt="facebook" align="left"/></a></div>
					<div id="fb-root"></div>
...
<?php require("footernewdesign.php"); ?>