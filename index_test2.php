...
<div id="tS2" class="jThumbnailScroller">
	...
	<div class="jTscrollerContainer">
        ...
        <A href="https://honestinstall.com/pricing-and-services.php"><IMG alt="Fireplace FAQs" src="images/Banner-Ad-Fireplaces-sized.jpg"></A>
        <A href="#"><IMG alt="Elite TVs" src="images/Banner-Ad-EliteTV2.jpg"></A><A 

      href="http://www.honestinstall.com/product-universalremote.php"><IMG alt="Universal Remotes" 

      src="images/banner_03.jpg"></A><A href="https://honestinstall.com/fireplace-faqs.php"><IMG 
...
<div style="float:right;position:relative;top:-25px"><small>To see more, click on the right arrow above&nbsp;&nbsp;&nbsp;&nbsp;</small></div>

<div style="font-weight:bold;font-size:16px;clear:both;">Featured Customer Reviews</div>
...
<script src="includes/jquery.thumbnailScroller.js"></script>
      ...
      href="http://www.honestinstall.com/spotlight.php"><IMG border=0 

      hspace=0 alt="" src="http://www.honestinstall.com/images/Honest-Spotlight-Boyscouts.jpg" width=729 

      height=469></A><BR>
<div style="float:right;position:relative;top:-4px;font-size:12px;font-weight:normal;font-family:arial"><small><a href="/spotlight.php">View Spotlight Page</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><BR></P><FONT size=3>
...
<A style="POSITION: relative; PADDING-BOTTOM: 0px; MARGIN: 0px; PADDING-LEFT: 0px; WIDTH: 150px; PADDING-RIGHT: 0px; DISPLAY: block; HEIGHT: 57px; OVERFLOW: hidden; PADDING-TOP: 0px" 
      ...
      <SCRIPT type=text/javascript>var bbbprotocol = ( ("https:" == document.location.protocol) ? "https://" : "http://" ); document.write(unescape("%3Cscript src='" + bbbprotocol + 'seal-dallas.bbb.org' + unescape('%2Flogo%2Fhonest-install-90343905.js') + "' type='text/javascript'%3E%3C/script%3E"));</SCRIPT>
            ...
            <?php require("footer.php"); ?><?php require("footerNav.php");?>
