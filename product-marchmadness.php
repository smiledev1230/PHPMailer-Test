...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE>March Madnesss Deals - Honest Install - TV INSTALLATION, HOME THEATER & AUDIO/VIDEO - Dallas, Texas</TITLE>
  ...
  <TR vAlign=top>
    <TD class=mainBG><BR><BR>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD><FONT size=4><STRONG><FONT face=Arial>March Madnesss 
            Deals</FONT></STRONG></FONT></TD>
          <TD align=right><FONT size=4><FONT face=Arial>from 
            $199.00</FONT></FONT></TD></TR></TBODY></TABLE>
      <DIV class=rndbg>
      <DIV align=center><IMG src="images/march.png" width=746><IMG 
...
dateFuture1 = new Date(2012,03,02,0,0,0);
...
function GetCount(ddate,iid){
	...
	if(amount < 0){
		document.getElementById(iid).innerHTML="<a href='#contactus'>Expired! - Click to see if promo is eligible for extension.</a>";
	}
	// else date is still good
		...
		document.getElementById(iid).innerHTML='Deals Expires on:  04-02-12 - <strong>' + out +'</strong> - Limited Appointments Available';
      ...
      <TABLE class=pd border=0 cellPadding=0 width="100%">
        ...
        <TR>
          <TD vAlign=top align="left">
            ...
            <P><STRONG>You want to see Brackets? Well, we've got that covered 
            (TV brackets that is). Get ready for the 
            Madness:<BR></STRONG><BR><STRONG><U><FONT size=4><FONT size=+0><FONT 
            size=+0><FONT color=#f9ae00><FONT color=#ecb100 size=+0>Deal #1<FONT 
            size=+0></FONT>:</FONT> 
            <BR></FONT></FONT></FONT></FONT></U></STRONG></P>
            ...
            education<BR><BR><STRONG><U><FONT size=4><FONT color=#ecb100 
            size=+0>Deal #2:</FONT> </FONT></U></STRONG></P>
            <P><STRONG>Premium TV Mounting w/ Wire Concealment &amp; Bracket 
            $399 <BR></STRONG><FONT size=2>(Reg.&nbsp;Price </FONT><FONT 
            size=2><FONT color=#808080><STRIKE><FONT 
            ...
            10ft.<BR></FONT><BR><STRONG><U><FONT size=4><FONT color=#ecb100 
            size=+0>Deal #3:</FONT> </FONT></U></STRONG></P>
            <P><STRONG>Premium TV Mounting&nbsp;&amp; Universal Remote $599 
            <BR></STRONG><FONT size=2>(Reg.&nbsp;Price </FONT><FONT size=2><FONT 
            color=#808080><STRIKE><FONT 
            name="MS Sans Serif">$746.00</FONT></STRIKE>)<BR><BR></FONT></FONT>-Mounting 
            of any TV up to 60� <BR>-Logitech Harmony 700 Universal Remote w/ 
            Custom Programming&nbsp;<BR>-2 FREE HDMI cables (two 6ft or one 
            12ft)<BR>-Premium Tilt Bracket<BR>-In-Wall Wire Concealment with 
            Electrical Outlet*<BR>-Setup &amp; configure 
            components/devices<BR>-Customer tutorial &amp; 
            education<BR><BR><FONT size=1>*Basic wire concealment is from TV 
            area, straight down below, to component area, max distance of 
            10ft.</FONT><BR><BR></P></TD></TR></TBODY></TABLE></DIV></DIV><IMG 
      src="../../../../../images/bottomround.jpg"> 
      <DIV class=formbox><A name=contactus></A>
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD vAlign=top><BR><BR><TEXTAREA class=txtheight onClick="document.serviceform.Comments.value='';" rows=15 cols=36 name=Comments>Comments</TEXTAREA><BR><BR><INPUT 
            ...
            value="March Madness Deals Inquiry" type=hidden name=subject> <INPUT 
