  ...
  <TR vAlign=top>
    <TD class=mainBG><BR><BR>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD><FONT size=4><STRONG><FONT face=Arial>Internet Radio</FONT></STRONG></FONT></TD>
          <TD align=right><FONT size=4><FONT 
        face=Arial>from $149 + Installation</FONT></FONT></TD></TR></TBODY></TABLE>
      <DIV class=rndbg>
      <DIV align=center><IMG src="images/product-image-internet-radi.png" 
      width=746></DIV>
      <DIV class=proddetail>
            <H4>Details</H4>details here
           </DIV></DIV><IMG 
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD vAlign=top><BR><BR><TEXTAREA class=txtheight onClick="document.serviceform.Comments.value='';" rows=15 cols=36 name=Comments>Comments</TEXTAREA><BR><BR><INPUT 
            ...
            value="Internet Radio Inquiry" type=hidden name=subject> <INPUT 
