		...
		<!-- wrapper !-->
			...
			<div id="wrapper">
				...
				<div class="header header-hr">
				    ...
				    <a class="logo-hr" href="/"></a>

                    <p class="header-text">
                    <span class="companydesc"><span class="tophead">Sales, Design & Installation:</span><br />
<span class="bottomhead">

Home Technology & Commercial A/V</span>
                    </span>

<span class="rev"><a style="color:#3e82ff;text-decoration:none" onclick="window.open('https://www.customerlobby.com/reviews/403/honest-install/' ,'ReviewPage', 'statusbar=no,menubar=no,toolbar=no,scrollbars=yes,resizable=yes,width=540, height=575,left=570,top=200,screenX=570,screenY=200'); return false;" href="https://www.customerlobby.com/reviews/403/honest-install/" target=_blank"><img src="/images/five-stars-600-reviews.png" alt="5 star ratings" class="reviewstar"/>600+ Reviews</span><br />

<span class="morethan">More than any other provider<br />

in Dallas/Ft. Worth!*</a></span>
						...
						<ul id="nav" class="dropdown dropdown-linear dropdown-columnar">
							...
							<li class="dir" onmouseover="" >
								...
								<ul>
									...
									<li><a onclick="window.open('https://www.customerlobby.com/reviews/403/honest-install/' ,'ReviewPage', 'statusbar=no,menubar=no,toolbar=no,scrollbars=yes,resizable=yes,width=540, height=575,left=570,top=200,screenX=570,screenY=200'); return false;" href="https://www.customerlobby.com/reviews/403/honest-install/" target=_blank>Customer Lobby (<?php echo $total_review; ?>)</a></li>
            ...
            <li><a href="https://plus.google.com/116147382403336090084/about?hl=en" target="_blank">Google Reviews</a></li>
									...
									<li><a href="https://www.houzz.com/pro/honestinstallav/honest-install" target="_blank">Houzz Reviews</a></li>
								...
								<ul>
									...
									<li class="dir">
										...
										<ul>
											...
											<li><a href="https://www.samsung.com/us/video/tvs" target="_blank">Samsung TVs</a></li>
...
<a href="/careers.php"><img src="/images/Help-Wanted--Lead-Tech2.jpg" alt="hiring now" /></a>
					

                    <div class="heading-menu" style="font-size:18px;font-family: 'archivo_narrowregular',sans-serif;">

						<!--<a href="/blog">Blog</a>&nbsp;&nbsp; <a href="/careers.php">Careers</a>-->

                        <i class="icon-phone"></i>Call Today: <b><a href="tel:972-470-3528">972-470-3528</a></b> <i class="icon-service"></i>Award Winning Service: <b><a href="contact.php" style="text-decoration:underline;color:#f9ce08" class="hirelink">Hire Honest</a></b>
