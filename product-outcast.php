<?php $menu="outcast";include("header.php"); ?>
	<div class="mainBG"><br><br>
		<div class="column-half text-left" style="padding-left:50px"><font size="4" face="Arial"><strong>Outcast&nbsp;- Wireless&nbsp;Portable Speaker System</strong></font></div>
		<div class="column-half text-right" style="padding-right:50px"><font size="4" face="Arial">from $649.00 + Installation</font></div>
		<div class="clear"></div>
		<div class="rndbg">
			<div id="gallery" class="ad-gallery">
				<div class="ad-image-wrapper"></div>
				<div class="image-746">
					<img src="images/fadeline.jpg"><br>
				</div>
			...
			<br><!--PDF download here-->
			<div align="center">
				<a href="../../../../../download/Honest%20Install%20Outcast%20Feature%20Sheet.pdf" target="_blank">
					<img alt="download" src="../../../../../images/pdf.png">
				</a> 
				&nbsp;&nbsp; <!--Video play here-->
				<a href="http://www.youtube.com/watch?v=MaB9RhZunsk" rel="lightbox">
					<img alt="Video" src="../../../../../images/Outcast-Video-Thumbnail-1.jpg">
				</a> 
				&nbsp;&nbsp; <!--Video play here--><a href="http://www.youtube.com/watch?v=OQI1HuakwSk" rel="lightbox">
					<img alt="Video" src="../../../../../images/Outcast-Video-Thumbnail-2.jpg">
				</a>
			</div>
			</div><BR>
					...
					<div class="fadetop">
						...
						<div class="fadedetail">
							<div class="fadecontent">
								...
								<font size=1>*iPod dock comes with standard Outcast unit. With Outcast Jr.&nbsp;iPod dock is optional and sold seperatly. <br></font><br>
							</div>
						</div>
