...
<?php $menu=""; include("includes/menu2.php"); ?>
  ...
  <TR vAlign=top>
    <TD class=mainBG><BR><BR>
      <TABLE border=0 cellPadding=0 width="100%">
        <TBODY>
        <TR>
          <TD style="padding-left:50px"><FONT size=4><STRONG><FONT face=Arial>Service 
            Call</FONT></STRONG></FONT></TD>
          <TD align=right style="padding-right:50px"><FONT size=4><FONT 
        face=Arial>$149</FONT></FONT></TD></TR></TBODY></TABLE>
      <DIV class=rndbg>
      <DIV align=center><IMG src="images/product-image-servicecall.png" 
      width=746></DIV>
      ...
      <TABLE border=0 cellPadding=0 width="100%">
        ...
        <TR>
          ...
          <TD vAlign=top width="35%">
            ...
            <H4>What Customers Say</H4>"I found Honest Install on the Internet when I 
            was searching for home theater installation services in my area. I 
            also contacted a couple of other companies but, by the time one guy 
            called me back, I had already scheduled a service call with Honest 
            Install. As far as the North Texas area goes, they are the most 
            professional, courteous, top-notch home theater company I have ever 
            dealt with!</DIV>
            <DIV class=custreview><BR>By Mike G<BR>Allen, TX 
      </DIV></TD></TR></TBODY></TABLE></DIV></DIV><IMG 
      src="../../../../../images/bottomround.jpg" style="padding-left:48px"> 
      <DIV class=formbox>
