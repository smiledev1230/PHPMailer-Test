...
<span class="rev"><a onclick="window.open('http://www.customerlobby.com/reviews/403/honest-install/' ,'ReviewPage', 'statusbar=no,menubar=no,toolbar=no,scrollbars=yes,resizable=yes,width=540, height=575,left=570,top=200,screenX=570,screenY=200'); return false;" href="http://www.customerlobby.com/reviews/403/honest-install/" target=_blank"><img src="/images/five-stars-600-reviews.png" alt="5 star ratings" class="reviewstar"/>600+ Reviews</span><br />
            ...
            <li><a href="https://plus.google.com/116147382403336090084/about?hl=en" target="_blank">Google Reviews</a></li>
				...
				<div class="mainBG" align="center">
                    ...
                    <div class="heading-menu" style="font-size:18px;font-family: 'archivo_narrowregular',sans-serif;">
                        ...
                        <i class="icon-phone"></i>Call Today: <b><a href="tel:972-470-3528">972-470-3528</a></b> <i class="icon-service"></i>Award Winning Service: <b><a href="contact.php" class="hirelink" style="text-decoration:underline;color:#f9ce08">Hire Honest</a></b>
