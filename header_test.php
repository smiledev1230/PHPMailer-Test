			...
			<div id="wrapper">
				...
				<div class="header header-hr">
                    ...
                    <p class="header-text">
                        ...
                        <span>Home Technology &amp; Commercial A/V</span>
            ...
            <li><a href="https://plus.google.com/116147382403336090084/about?hl=en" target="_blank">Google Reviews</a></li>
				...
				<div class="mainBG" align="center">
                    ...
                    <div class="heading-menu" style="font-size:18px;font-family: 'archivo_narrowregular',sans-serif;">
                        ...
                        <i class="icon-phone"></i>Call Today: <b><a href="tel:972-470-3528">972-470-3528</a></b> <i class="icon-service"></i>Award Winning Service: <b><a href="contact.php">Hire Honest</a></b>
