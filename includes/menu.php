...
<div id="wrapper">
    ...
    <li><a href="/product-giftidea.php" class="dir2" <? if($menu=="products") echo 'id="active"'; ?>>Products &amp; Equip</a>
      ...
      <li><a href="/product-prepaid.php" class="dir" <? if($menu=="gc") echo 'id="active"'; ?>>Gift Cards</a>
      	<ul>
			<li><a href="/product-prepaid.php">Prepaid Install Cards</a></li>
            <li><a href="/product-giftidea.php">Holiday Gift Ideas</a></li>
		</ul>
      </li>
      
      <li><a href="/process.php" class="dir" <? if($menu=="process") echo 'id="active"'; ?>>LEARN</a>
		<ul>
      ...
      target=_blank>Customer Lobby</a></li>
     ...
     <li><a href="/about.php" class="dir" <? if($menu=="about") echo 'id="active"'; ?>>About</a>
       <ul>
...
<div id="rotator"><span class="schedule"><a href="http://www.honestinstall.com/contact.php">Schedule Service/Request a Quote</a></span><div onclick="location.href='http://www.honestinstall.com/product-giftidea.php';"  class="gideabox"></div></div></div>
<TABLE border=0 cellSpacing=0 cellPadding=0 width=850 align=center >
  <TBODY>
  <TR vAlign=top>
    <TD class=mainBG align="center"><br />
    <DIV class="headfont">Honest Install - TV INSTALLATION, HOME THEATER & AUDIO/VIDEO - Dallas, Texas
</DIV>
<? if($menu!="home") {
echo
<<<ENDH
