...
document.write('<span id="trace0_'+i_tem+'" style="cursor:pointer;padding-left:5px;padding-right:5px;padding-bottom:2px;background-color:'+(i_tem? '#fbda55' : 'white')+';" onclick="if (iss[0].playing){iss[0].gostop(iss[0].go(\'gostp0\'));setTimeout(\'iss[0].jumper('+[i_tem+1]+')\', 1000);}else{iss[0].jumper('+[i_tem+1]+');}">'+[i_tem+1]+'<\/span> ');
document.write('<\/div>')
...
spans[i_tem].style.width="18px";
spans[i_tem].style.height="18px";}
this.go('trace'+this.issid+'_'+this.keeptrack()).style.backgroundColor='white';
}
if (this.jumpto)
