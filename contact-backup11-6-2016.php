<?php $menu="contact"; if(isset($_GET["menu"])) {if($_GET["menu"]!='') $menu=$_GET["menu"];} include("header.php"); ?>
	<div class="mainBG"><br>
		<div class="contact-box">
			<div class="left-contact"><br>
				<font size="+1">Talk to Us</font><br><br>
				<?php include ("includes/jf-contact.php"); ?>
			</div>
			<div class="right-contact">
				<br><font size="+1">Contact Us</font>
				<div class="contact-content" style="padding-left:20px;padding-top:20px;">
					<strong><h4>Sales & Service</h4>
Phone:<br>
					<span style="font-size:13px">972-470-3528</span></strong><br><br>
					
					<strong>E-Mail:</strong><br>
					info@honestinstall.com<br><br>
					<strong>Serving Dallas Ft. Worth</strong><br /><br />
					<strong>Operation:</strong><br><br>
					Sales: 9am to 6pm (Mon-Sat)<br />
					Admin: 9am to 6pm (Mon-Fri) <br />
					Install Team: Monday-Saturday <br>
<br>
<br>
