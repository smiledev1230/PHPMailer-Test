                                                                            ...
                                                                            <?php foreach ($productsarray as $product) : ?>
                                                                                <td align="center" valign="top" width="172">
                                                                                    <table cellpadding="1" cellspacing="1" border="0" width="172">
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center">
                                                                                                <font face="Verdana, Arial, Helvetica, sansserif" size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #7f7f7f;"><?php echo $product['name']; ?></font> <input type="checkbox" name="[product][<?= $product['cid'];?>][<?= $product['pid']; ?>]" /><br />
