...
<table cellpadding="0" cellspacing="0" border="0" width="710">
	...
	<tr>
		<td style="padding-left: 15px;">
			<font face="Verdana, Arial, Helvetica, sansserif" size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 9pt; color: #000000;">
			...
			-Honest Install | Service Team. TEST
			</font>
		</td>
	</tr>
	...
	<?php foreach($productsarray as $product) : ?>
		<td align="center" valign="top" width="172">
			<table cellpadding="1" cellspacing="1" border="0" width="172">
				...
				<tr>
					<td align="center">
						<font face="Verdana, Arial, Helvetica, sansserif" size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #7f7f7f;"><?php echo $product['name']; ?></font> <input type="checkbox" name="product_<?php echo $product['cid'].'-'.$product['pid']; ?>" /><br />
		...
		<?php if($i==4) { $i=1; echo '</tr><tr>'; } else { $i++; } ?>
	<?php endforeach; ?>
										</tr>
										<tr><td height="25" colspan="4"></td></tr>
									<?php endforeach; ?>
