<html>
    ...
    <body style="font-family: Verdana, Arial, sans-serif; font-size: 13px;">
        ...
        <?php //var_dump($contentTemplate['Email_template']['content']); ?>
                        ...
                        <tr>
                            <td style="padding-left: 15px;">
                                ...
                                <?php /*
                                  ...
                                  <b>DATE: <?php echo $date_appointment; ?> ARRIVAL: <?php echo $time_in; ?></b><br /><br />
        ...
        click <a href="https://honestinstall.com/admin/app/webroot/index.php/appointments/mail_back/<?= $appointment_id; ?>">here</a>if this email does not belong to you link.
        <br/><br/>
