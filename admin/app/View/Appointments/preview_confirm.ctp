...
<body style="font-family: Verdana, Arial, sans-serif; font-size: 13px;">
    <?php echo $this->Form->create('Appointment', array('url' => 'email_visitor/')); ?>
    <h2> Email Preview</h2>
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="710">
                    ...
                    <tr>
                        <td style="padding-left: 15px;">
                            ...
                            <?= $this->Form->hidden('email', array('value' => $email)); ?>
                                                                    ...
                                                                    <?php foreach ($productsarray as $product) : ?>
                                                                        <td align="center" valign="top" width="172">
                                                                            <table cellpadding="1" cellspacing="1" border="0" width="172">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <font face="Verdana, Arial, Helvetica, sansserif" size="1" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8pt; color: #7f7f7f;"><?php echo $product['name']; ?></font> <input type="checkbox" name="data[products][<?= $product['pid']; ?>]" value="<?= $product['cid']; ?>" checked="checked" /><br />
    ...
    <div style="float: left; width: 200px;">
        <?= $this->Form->button('Back', array('class' => 'orangebutton', 'type' => 'button', 'onclick' => 'javascript: history.go(-1)')); ?>    
    </div>
    <div style="float: left;">
        <input class="orangebutton" type="submit" value="Send Email" style="float: left;" />
        <?= $this->Form->end(); ?>
    </div>
